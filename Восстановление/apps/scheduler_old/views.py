...
def staff_selector_views(request):
    ...
    return render(request, 'scheduler_old/scheduler_today.html', data)
...
def test(request):
    ...
    #print('form: ', form.values())
    return render(request, 'scheduler_old/test.html', data)
...
def create_new_event(request, productid):
    ...
    return render(request, 'scheduler_old/create_new_event.html', data)

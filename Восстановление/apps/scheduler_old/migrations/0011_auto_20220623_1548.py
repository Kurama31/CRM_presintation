...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scheduler_old', '0010_company_staff_employer_phone_number'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='scheduler_db',
            name='staff_lastname',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='scheduler_old.company_staff'),
        ),
        migrations.AddField(
            model_name='scheduler_db',
            name='staff_name',
